...
/* .Call calls */
extern SEXP betweenrangeoo(SEXP, SEXP, SEXP);
extern SEXP cbind_matrix(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP convert_key_to_vector_SEXP(SEXP);
extern SEXP convert_vector_Rrows_to_Crows(SEXP, SEXP);
extern SEXP convert_vector_to_key_SEXP(SEXP);
extern SEXP create_hashmap_SEXP(SEXP);
extern SEXP create_hashtable_SEXP(SEXP, SEXP);
extern SEXP create_matrix_general_hashtable_SEXP(SEXP, SEXP, SEXP, SEXP);
extern SEXP create_matrix_hashtable_SEXP(SEXP);
extern SEXP create_sparsematrix_SEXP(SEXP, SEXP);
extern SEXP dim_sparsematrix_SEXP(SEXP);
extern SEXP dump_long_format_sparsematrix(SEXP);
extern SEXP find_position_hashtable_SEXP(SEXP, SEXP, SEXP, SEXP);
extern SEXP find_position_matrix_general_hashtable_SEXP(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP find_position_matrix_hashtable_SEXP(SEXP, SEXP, SEXP, SEXP);
extern SEXP get_elements_sparsematrix_SEXP(SEXP, SEXP, SEXP, SEXP);
extern SEXP get_first_element_of_list_of_integers(SEXP);
extern SEXP get_hashmap_SEXP(SEXP, SEXP);
extern SEXP get_key_by_position_hashmap_SEXP(SEXP, SEXP);
extern SEXP get_list_of_rows_with_same_values_in_this_matrix(SEXP, SEXP, SEXP);
extern SEXP get_number_of_processors_available(void);
extern SEXP get_order_pos(SEXP, SEXP);
extern SEXP get_positions_hashtable_SEXP(SEXP);
extern SEXP get_rescale_matrix(SEXP, SEXP, SEXP);
extern SEXP get_segments_of_points_matrix(SEXP, SEXP);
extern SEXP get_size_hashtable_SEXP(SEXP);
extern SEXP get_value_by_position_hashmap_SEXP(SEXP, SEXP);
extern SEXP insert_elements_sparsematrix_SEXP(SEXP, SEXP, SEXP, SEXP);
extern SEXP insert_hashmap_SEXP(SEXP, SEXP, SEXP);
extern SEXP insert_list_hashmap_SEXP(SEXP, SEXP, SEXP);
extern SEXP length_hashmap_SEXP(SEXP);
extern SEXP match_matrix(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP orderBoundingBoxes(SEXP, SEXP, SEXP, SEXP);
extern SEXP size_sparsematrix_SEXP(SEXP);
extern SEXP tic_named_SEXP(SEXP);
extern SEXP tic_SEXP(void);
extern SEXP toc_print_timer_SEXP(SEXP);
extern SEXP toc_SEXP(void);
extern SEXP toc_timer_SEXP(SEXP);
